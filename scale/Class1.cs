...
namespace WuJian.Common
{
    ...
    public class Image
    {
        ...
        /// 最大高(单位:px)
        /// 质量（范围0-100）
        public static void CutForCustom(string fromFile, string savePath, string fileSaveUrl, int maxWidth, int maxHeight, int quality)
        {
            ...
            if (maxWidth <= 0)
            {
                double width = (double)maxHeight / initImage.Height * initImage.Width;
                maxWidth = (int)width;
            }
            if (maxHeight <= 0)
            {
                double height = (double)maxWidth / initImage.Width * initImage.Height;
            ...
            else
            {
                ...
                else
                {
                    ...
                    //保存缩略图
                    newImage.Save(fileSaveUrl, ici, ep);
                    //templateImage.Save(fileSaveUrl, System.Drawing.Imaging.ImageFormat.Jpeg);
